...
import com.example.geomob2.Adapters.HistoriqueAdapter
import com.example.geomob2.Adapters.PersonnalitesAdapter
import com.example.geomob2.Model.*
...
class DetailActivity : AppCompatActivity(){
    ...
    private var recyclerViewY: RecyclerView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewY = findViewById(R.id.Listyoutub)
        recyclerViewY!!.setLayoutManager(LinearLayoutManager(this))
    ...
    private fun GetVideos(country:String) {
        val url = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&order=date&q="+country+"&type=video&key=AIzaSyAvwEQzek_LSont6cZdI9ERmvk4fSp6FGw"
        ...
        client.newCall(request).enqueue(object: Callback {
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    ...
                    recyclerViewY!!.adapter = YoutubeListAdapter(videos)
                }
